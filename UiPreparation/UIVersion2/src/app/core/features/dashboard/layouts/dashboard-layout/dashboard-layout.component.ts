...
import {DashboardLayoutTopbarComponent} from './dashboard-layout-topbar/dashboard-layout-topbar.component';
...
export class DashboardLayoutComponent implements OnInit {
  ...
  appSidebar!: DashboardLayoutSidebarComponent;

  @ViewChild(DashboardLayoutTopbarComponent)
  appTopbar!: DashboardLayoutTopbarComponent;
